<div class="bg-gray-100 min-h-[100svh] flex">
    ...
    {{-- header --}}
    <div x-data="dropdown" class="w-full">
        ...
        <div class="p-5">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Messages</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="py-10 max-h-[80svh] overflow-x-auto ">
                <div class="bg-white">
                    <header class="w-full text-white py-3 px-4 bg-[#791417]">
                        @if ($convo->type == 'company')
                        {{ $convo->company?->company_name }}
                        @else
                        {{ $convo->student?->firstname }}
                        @endif
                    </header>
                    {{-- message container --}}
