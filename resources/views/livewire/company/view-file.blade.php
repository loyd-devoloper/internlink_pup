    ...
    <div>
        ...
        @if ($type == 1)
            ...
            @if ($record->resume_type == '0')
               ...
               @endif
            @else
                <object data="{{ asset('storage/' . $record->resume) }}" type="application/pdf" width="100%"
                    height="500px">
                    <p>Unable to display PDF file. <a href="{{ asset('assets/No_files_Upload.pdf') }}">Download</a>
                        instead.</p>
                </object>
            @endif
        @elseif($type == 2)
            <object data="{{ asset('storage/' . $record->endorsement_letter) }}" type="application/pdf" width="100%"
                height="500px">
                <p>Unable to display PDF file. <a href="{{ asset('assets/No_files_Upload.pdf') }}">Download</a>
                    instead.</p>
            </object>
        @elseif($type == 3)
            <object data="{{ asset('storage/' . $record->internship_agreement) }}" type="application/pdf"
                width="100%" height="500px">
                <p>Unable to display PDF file. <a href="{{ asset('assets/No_files_Upload.pdf') }}">Download</a>
                    instead.</p>
            </object>
        @elseif($type == 4)
            <object data="{{ asset('storage/' . $record->insurance) }}" type="application/pdf" width="100%"
                height="500px">
                <p>Unable to display PDF file. <a href="{{ asset('assets/No_files_Upload.pdf') }}">Download</a>
                    instead.</p>
            </object>
